		...
		\resumeWorkSubheading
			...
			{Computer Vision, DL and SLAM Research Engineer}{July 2021 \textbf{--} July 2023}      
				\resumeItemListStart 
					...
					\resumeItem{Developed an end to end autonomous driving agent using cameras, GPS and IMU sensors}
					\resumeItem{Ported the agent from Carla simulator to NuScenes Dataset}
