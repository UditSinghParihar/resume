		...
		\resumeWorkSubheading
			...
			{Computer Vision, DL and SLAM Research Engineer}{July 2023 \textbf{--} Present}
				\resumeItemListStart
					...
					\resumeItem{Debugged and contributed to C++ codebase maintained by team of 40 engineers in Qualcomm and Google}
					\resumeItem{Brought down 6DoF accuracy under 5 mm and improvement of 50\% in low texture and HDR scenarios}
					\resumeItem{Made key contribution to detection, stereo triangulation and tracking in VIO}
					\vspace{7px}
					...
					\textbf{Fusing IMU with Camera based deep feature matching (Patent submission):} \vspace{-2px}
					\resumeItem{First in literature to integrate IMU with camera based deep feature matching}
					\resumeItem{Solves the problem of matching in low texture environment, high rotation changes}
					\resumeItem{IMU guided optical flow and occlusion modeling}
					\vspace{7px}
				\resumeItemListEnd 
		...
		\resumeWorkSubheading
			...
			{Computer Vision, DL and SLAM Research Engineer}{July 2021 \textbf{--} July 2023}      
				\resumeItemListStart 
					...
					\resumeItem{Converted the pytorch model to TensorRT and developed a ROS wrapper to run on real Mahindra E2O car achieving final control prediction at 25 HZ, in a zero shot paradigm}
					\vspace{7px}
